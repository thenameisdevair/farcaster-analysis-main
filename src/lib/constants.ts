 ...
 */
export const APP_NAME: string = 'Farcaster analysis';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Analyze your Activity';
 ...
 */
export const APP_TAGS: string[] = ['Utility', 'finacne'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Analyze';
